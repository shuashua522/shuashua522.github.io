...
<span class="line"><span>&lt;/configuration&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><p>若使用 TCP 而非 UDP，将GelfUdpAppender替换为GelfTcpAppender，并确保 Graylog 输入源对应 TCP。</p></li><li><p>host需填写部署 Graylog 的服务器 IP（本地测试可用<a href="http://localhost" target="_blank" rel="noopener noreferrer">localhost</a>）。</p></li></ul><h3 id="步骤-6-验证日志收集" tabindex="-1"><a class="header-anchor" href="#步骤-6-验证日志收集"><span><strong>步骤 6：验证日志收集</strong></span></a></h3><ol><li><p>启动项目，触发一些日志输出（<a href="http://xn--logger-hh4k.info" target="_blank" rel="noopener noreferrer">如logger.info</a>(&quot;test graylog&quot;)）。</p></li><li><p>回到 Graylog Web 界面，左侧菜单点击 <strong>Search</strong>，即可看到项目发送的日志（可能需要等待几秒刷新）。</p></li></ol><h3 id="常见问题排查" tabindex="-1"><a class="header-anchor" href="#常见问题排查"><span>常见问题排查</span></a></h3><ul><li><p><strong>Elasticsearch 启动失败</strong>：检查vm.max_map_count是否配置正确，或减少ES_JAVA_OPTS的内存（如-Xms256m -Xmx256m）。</p></li><li><p><strong>日志未接收</strong>：</p></li><li><p>检查 Graylog 的 GELF 输入源是否启动（System → Inputs中状态为Running）。</p></li><li><p>验证项目logback.xml的host和port是否正确，服务器防火墙是否开放 12201 端口。</p></li><li><p>查看 Graylog 容器日志：docker logs graylog-server，排查连接错误。</p></li></ul><p>通过以上步骤，即可在 Docker 中部署 Graylog 并结合logback-gelf实现日志收集。</p>`,36)])])}const t=n(i,[["render",p]]),o=JSON.parse('{"path":"/shua_blog/%E5%9C%A8docker%E4%B8%8A%E9%83%A8%E7%BD%B2Graylog.html","title":"在docker部署Graylog","lang":"zh-CN","frontmatter":{"title":"在docker部署Graylog","icon":"pen-to-square","date":"2025-10-26T00:00:00.000Z","category":["Java"],"tag":["docker","kafka"],"description":"服务器环境 Ubuntu-22.04 安装docker Ubuntu | Docker Docs --- Ubuntu | Docker Docs 安装后 Docker 服务会自动启动。要验证 Docker 是否正在运行，请使用： 配置docker镜像 配置镜像： 验证镜像是否生效： 输出中若能看到 Registry Mirrors: 你的镜像地址/，...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"在docker部署Graylog\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2025-10-26T00:00:00.000Z\\",\\"dateModified\\":\\"2025-12-19T13:53:35.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"shuashua\\",\\"url\\":\\"https://mister-hope.com\\"}]}"],["meta",{"property":"og:url","content":"https://mister-hope.github.io/shua_blog/%E5%9C%A8docker%E4%B8%8A%E9%83%A8%E7%BD%B2Graylog.html"}],["meta",{"property":"og:site_name","content":"shuashua的博客"}],["meta",{"property":"og:title","content":"在docker部署Graylog"}],["meta",{"property":"og:description","content":"服务器环境 Ubuntu-22.04 安装docker Ubuntu | Docker Docs --- Ubuntu | Docker Docs 安装后 Docker 服务会自动启动。要验证 Docker 是否正在运行，请使用： 配置docker镜像 配置镜像： 验证镜像是否生效： 输出中若能看到 Registry Mirrors: 你的镜像地址/，..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-12-19T13:53:35.000Z"}],["meta",{"property":"article:tag","content":"kafka"}],["meta",{"property":"article:tag","content":"docker"}],["meta",{"property":"article:published_time","content":"2025-10-26T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2025-12-19T13:53:35.000Z"}]]},"git":{"createdTime":1764575691000,"updatedTime":1766152415000,"contributors":[{"name":"shuashua522","username":"shuashua522","email":"shuashua_world@163.com","commits":2,"url":"https://github.com/shuashua522"}]},"readingTime":{"minutes":4.28,"words":1284},"filePathRelative":"shua_blog/在docker上部署Graylog.md","excerpt":"<h2>服务器环境</h2>\\n<p>Ubuntu-22.04</p>\\n<h2>安装docker</h2>\\n<blockquote>\\n<p><a href=\\"https://docs.docker.com/desktop/setup/install/linux/ubuntu/\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">Ubuntu | Docker Docs --- Ubuntu | Docker Docs</a></p>\\n</blockquote>\\n<p>安装后 Docker 服务会自动启动。要验证 Docker 是否正在运行，请使用：</p>\\n<div class=\\"language- line-numbers-mode\\" data-highlighter=\\"shiki\\" data-ext=\\"\\" style=\\"--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34\\"><pre class=\\"shiki shiki-themes one-light one-dark-pro vp-code\\"><code class=\\"language-\\"><span class=\\"line\\"><span>sudo systemctl status docker</span></span></code></pre>\\n<div class=\\"line-numbers\\" aria-hidden=\\"true\\" style=\\"counter-reset:line-number 0\\"><div class=\\"line-number\\"></div></div></div>","autoDesc":true}');export{t as comp,o as data};
